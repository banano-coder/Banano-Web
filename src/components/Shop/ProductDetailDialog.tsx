...
export const ProductDetailDialog: React.FC<ProductDetailDialogProps> = ({ productId, isOpen, onClose }) => {
                ...
                if (qty > 0) {
                    ...
                    const cartItemName = variantAttrs 
                     ...
                     addCartItem({
                        ...
                        // Use index as variantId to ensure uniqueness in cart even if DB IDs are duplicate
                        variantId: idx, 
                        name: cartItemName,
                                                ...
                                                >
                                                    <div className="flex flex-col min-w-0 flex-1 mr-4">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1">
                                                             <span className="font-bold text-sm">${variant.precio_lista}</span>
